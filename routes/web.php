...
Route::get('get-contact-form', [ClientHomeController::class, 'getContactForm'])->name('get-contact-form');
Route::post('contact-form', [ClientHomeController::class, 'contactForm'])->name('contact-form');
