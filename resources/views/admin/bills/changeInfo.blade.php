        ...
        <div class="row">
            <div class="col-lg-12 col-md-12">
                <div class="cart-table table-responsive">
                    ...
                    <form action="{{ route('admin.bill.admin-update-bill',$bills->id) }}" method="POST">
                        @csrf
                        @method('put')
                        <div class="row pt-5">
                            <div class="col-lg-12 col-md-12">
                                <div class="form-group">
                                    <label>Họ tên người nhận <span style="color: red" class="required">*</span></label>
                            ...
                            <div class="col-lg-6 col-md-6">
                                <div class="form-group">
                                    <label>Địa chỉ email <span style="color: red" class="required">*</span></label>
