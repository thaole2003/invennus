...
@section('content')
    <h1 class=" d-flex justify-content-center align-items-center" style="height: 80px">
        Sửa feedback</h1>
    <form action="{{ route('admin.feedbacks.update',$data->id) }}" method="post" enctype="multipart/form-data">
        @csrf
        @method('put')
        <div class="w-50 mx-auto border bg-light rounded h-100 p-4 mt-5">
            <a class="btn btn-warning" href="{{ route('admin.feedbacks.index') }}">Trở lại</a>

            <div class="mb-3 mt-3">
                <label for="email" class="form-label">Ảnh feedback:</label>
