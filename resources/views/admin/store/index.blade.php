...
@section('content')
    <div class="m-10">
        <h1 class="text-center">Danh sách store</h1>
    </div>
    <div>
    ...
    <div class="w-80">
        <button type="button" class="btn btn-info px-10"><a href="{{ route('admin.store.create') }}">Thêm mới</a></button>
        <table class="table">
            <thead>
                <tr>
                    <th scope="col">#</th>
                    ...
                    @foreach ($data as $key => $value)
                        <tr>
                            ...
                            <td class="d-flex align-items-center">
                                <button>
                                    <a href="{{ route('admin.store.edit', $value->id) }}">Sửa</a>
                                </button>
