...
<!-- Mirrored from frontend.big-skins.com/seiko/html/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 17 Jul 2023 13:38:42 GMT -->
...
<head>
    ...
    <!-- Vendor -->
    <link href="{{ asset('fe/js/vendor/bootstrap/bootstrap.min.css') }}" rel="stylesheet">
    <link href="{{ asset('fe/js/vendor/slick/slick.css') }}" rel="stylesheet">
    <link href="{{ asset('fe/js/vendor/swiper/swiper.min.css') }}" rel="stylesheet">
    <link href="{{ asset('fe/js/vendor/magnificpopup/dist/magnific-popup.css') }}" rel="stylesheet">
    <link href="{{ asset('fe/js/vendor/nouislider/nouislider.css') }}" rel="stylesheet">
    <link href="{{ asset('fe/js/vendor/darktooltip/dist/darktooltip.css') }}" rel="stylesheet">
    <link href="{{ asset('fe/css/animate.css') }}" rel="stylesheet">

    <!-- Custom -->
    <link href="{{ asset('fe/css/style.css') }}" rel="stylesheet">
    <link href="{{ asset('fe/css/megamenu.css') }}" rel="stylesheet">
    <link href="{{ asset('fe/css/tools.css') }}" rel="stylesheet">

    <!-- Color Schemes -->
    <link href="{{ asset('fe/css/style-color-pink.css') }}" rel="stylesheet">
    <link href="{{ asset('fe/css/style-color-green.css') }}" rel="stylesheet">
    <link href="{{ asset('fe/css/style-color-lightgreen.css') }}" rel="stylesheet">
    <link href="{{ asset('fe/css/style-color-blue.css') }}" rel="stylesheet">
    <link href="{{ asset('fe/css/style-color-lightblue.css') }}" rel="stylesheet">
    <link href="{{ asset('fe/css/style-color-violet.css') }}" rel="stylesheet">
    <link href="{{ asset('fe/css/style-color-tomato.css') }}" rel="stylesheet">
    <link href="{{ asset('fe/css/style-color-caribbean.css') }}" rel="stylesheet">
    <link href="{{ asset('fe/css/style-color-orange.css') }}" rel="stylesheet">

    <!-- Icon Font -->
    <link href="{{ asset('fe/fonts/icomoon-reg/style.css') }}" rel="stylesheet">
...
<body class="boxed">
    ...
    <div class="fixed-btns demo-mode">
        <!-- Tools Panel -->
        <div id="toolsPanel">
            <div class="btn-wrapper tools-btn">
                <a href="#" class="btn"><img src="images/animate-tools.gif" class="img-responsive"
                        alt=""></a>
            </div>
            <div class="block-tools">
                <label class="radio">
                    <input id="radio9" type="radio" name="layoutmodeblock" value="fullwidth">
                    <span class="outer"><span class="inner"></span></span>FULLWIDTH
                </label>
                <label class="radio">
                    <input id="radio10" type="radio" name="layoutmodeblock" value="boxed">
                    <span class="outer"><span class="inner"></span></span>BOXED
                </label>
                <label class="radio">
                    <input id="radio11" type="radio" name="layoutmodeblock" value="fullboxed">
                    <span class="outer"><span class="inner"></span></span>FULLBOXED
                </label>
                <div class="productpreview">
                    <div class="line-div"></div>
                    <h5>Product preview:</h5>
                    <label class="radio">
                        <input id="radio12" type="radio" name="productpreview" value="previewsmall">
                        <span class="outer"><span class="inner"></span></span>SMALL
                    </label>
                    <label class="radio prw2">
                        <input id="radio13" type="radio" name="productpreview" value="previewsmall2">
                        <span class="outer"><span class="inner"></span></span>SMALL2
                    </label>
                    <label class="radio">
                        <input id="radio14" type="radio" name="productpreview" value="previewbig">
                        <span class="outer"><span class="inner"></span></span>BIG
                    </label>
                </div>
            </div>
            <div class="panel-group" id="toolsAccord">
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <h4 class="panel-title">
                            <a data-toggle="collapse" data-parent="#toolsAccord" href="#collapseOne"><i
                                    class="icon icon-tool-layout"></i>Layout Mode</a>
                        </h4>
                    </div>
                    <div id="collapseOne" class="panel-collapse collapse in">
                        <div class="panel-body">
                            <label class="radio">
                                <input id="radio1" type="radio" name="layoutmodeall" value="fullwidth">
                                <span class="outer"><span class="inner"></span></span>FULLWIDTH
                            </label>
                            <label class="radio">
                                <input id="radio2" type="radio" name="layoutmodeall" value="boxed">
                                <span class="outer"><span class="inner"></span></span>BOXED
                            </label>
                        </div>
                    </div>
                ...
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <h4 class="panel-title">
                            <a data-toggle="collapse" data-parent="#toolsAccord" href="#collapseTwo"><i
                                    class="icon icon-tool-side"></i>Side Panel</a>
                        </h4>
                    </div>
                    <div id="collapseTwo" class="panel-collapse collapse">
                        <div class="panel-body">
                            <div class="checkbox-group">
                                <input type="checkbox" name="slidepanelshow" id="checkbox1">
                                <label for="checkbox1"><span class="check"></span><span
                                        class="box"></span>SHOW</label>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <h4 class="panel-title">
                            <a data-toggle="collapse" data-parent="#toolsAccord" href="#collapseThree"><i
                                    class="icon icon-tool-round"></i>Rounded</a>
                        </h4>
                    </div>
                    <div id="collapseThree" class="panel-collapse collapse">
                        <div class="panel-body">
                            <div class="checkbox-group">
                                <input type="checkbox" name="rounded" id="checkbox2">
                                <label for="checkbox2"><span class="check"></span><span
                                        class="box"></span>ON</label>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <h4 class="panel-title">
                            <a data-toggle="collapse" data-parent="#toolsAccord" href="#collapseFour"><i
                                    class="icon icon-tool-header"></i>Header</a>
                        </h4>
                    </div>
                    <div id="collapseFour" class="panel-collapse collapse">
                        <div class="panel-body">
                            <h5>sticky</h5>
                            <div class="checkbox-group">
                                <input type="checkbox" name="sticky" id="checkbox3">
                                <label for="checkbox3"><span class="check"></span><span
                                        class="box"></span>ON</label>
                            </div>
                            <div class="divider"></div>
                            <h5>blackout</h5>
                            <div class="checkbox-group">
                                <input type="checkbox" name="blackout" id="checkbox4">
                                <label for="checkbox4"><span class="check"></span><span
                                        class="box"></span>ON</label>
                            </div>
                            <div class="divider"></div>
                            <h5>animation</h5>
                            <div class="radioset">
                                <label class="radio">
                                    <input id="radio3" type="radio" name="menuanimation" value="none">
                                    <span class="outer"><span class="inner"></span></span>NONE
                                </label>
                                <label class="radio">
                                    <input id="radio4" type="radio" name="menuanimation" value="fade">
                                    <span class="outer"><span class="inner"></span></span>FADE
                                </label>
                                <label class="radio">
                                    <input id="radio5" type="radio" name="menuanimation" value="slide">
                                    <span class="outer"><span class="inner"></span></span>SLIDETOP
                                </label>
                            </div>
                        </div>
                    </div>
                ...
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <h4 class="panel-title">
                            <a data-toggle="collapse" data-parent="#toolsAccord" href="#collapseFive"><i
                                    class="icon icon-tool-color"></i>Color Scheme</a>
                        </h4>
                    </div>
                    <div id="collapseFive" class="panel-collapse collapse">
                        <div class="panel-body">
                            <ul class="color-list">
                                <li class="active"><a href="#" title="Red" data-tooltip="Red"><span
                                            class="value" data-color=""><span
                                                class="color color-red"></span></span></a></li>
                                <li><a href="#" data-tooltip="Orange" title="Orange"
                                        data-color="color-orange"><span class="value"><span
                                                class="color color-orange"></span></span></a></li>
                                <li><a href="#" data-tooltip="Blue" title="Blue"
                                        data-color="color-blue"><span class="value"><span
                                                class="color color-blue"></span></span></a></li>
                                <li><a href="#" data-tooltip="Light Green" title="Light Green"
                                        data-color="color-lightgreen"><span class="value"><span
                                                class="color color-lightgreen"></span></span></a></li>
                                <li><a href="#" data-tooltip="Green Caribbean" title="Green Caribbean"
                                        data-color="color-caribbean"><span class="value"><span
                                                class="color color-caribbean"></span></span></a></li>
                                <li><a href="#" data-tooltip="Green" title="Green"
                                        data-color="color-green"><span class="value"><span
                                                class="color color-green"></span></span></a></li>
                                <li><a href="#" data-tooltip="Pink" title="Pink"
                                        data-color="color-pink"><span class="value"><span
                                                class="color color-pink"></span></span></a></li>
                                <li><a href="#" data-tooltip="Violet" title="Violet"
                                        data-color="color-violet"><span class="value"><span
                                                class="color color-violet"></span></span></a></li>
                                <li><a href="#" data-tooltip="Light Blue" title="Light Blue"
                                        data-color="color-lightblue"><span class="value"><span
                                                class="color color-lightblue"></span></span></a></li>
                                <li><a href="#" data-tooltip="Tomato" title="Tomato"
                                        data-color="color-tomato"><span class="value"><span
                                                class="color color-tomato"></span></span></a></li>
                            </ul>
                        </div>
                    </div>
                </div>
        ...
        <!-- Tools Panel -->
        <!-- Buy Now -->
        <a href="https://themeforest.net/item/seiko-html-mobile-first/18941342?ref=bigsteps" target="_blank"
            class="buy-fixed-btn btn"><i class="icon icon-star"></i>BUY THEME</a>
        <!-- /Buy Now -->
        <!-- Back To Top -->
                        ...
                        <div class="header-links">
                            ...
                            <div class="header-link dropdown-link header-account">
                                ...
                                <div class="dropdown-container right">
                                    ...
                                    <div class="bottom-text">Create a <a href="account-create.html">New Account</a>
                                    </div>
                                </div>
                            </div>
                            <!-- /Header Account -->
                        ...
                        <div class="header-logo">
                            <a href="index-2.html" title="Logo">
                                <svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg"
                                    ...
                                    <rect x="2" y="17.99" fill="none" width="41.027"
                                        height="35.46" />
                                    <g>
                                        <path
                                ...
                                <ul class="nav">
                                    ...
                                    <li>
                                        ...
                                        <ul>
                                            <li>
                                                ...
                                                <ul>
                                                    ...
                                                    <li><a href="category-fixed-sidebar.html" title="">Listing
                                                            Fixed Filter<span class="menu-label-alt">NEW </span></a>
                                                    </li>
                                            ...
                                            <li>
                                                <a href="product.html" title="">Product</a><span
                                                    class="arrow"></span>
                                                <ul>
                                            ...
                                            <li>
                                                <a href="index-2.html" title="">Headers</a><span
                                                    class="arrow"></span>
                                                <ul>
                                            ...
                                            <li>
                                                <a href="index-2.html" title="">Footers</a><span
                                                    class="arrow"></span>
                                                <ul>
                                            ...
                                            <li>
                                                <a href="gallery.html" title="">Gallery</a><span
                                                    class="arrow"></span>
                                                <ul>
                            ...
                            <div class="swiper-container">
                                <div class="swiper-wrapper">
                                    ...
                                    <div class="swiper-slide" data-thumb="images/slider/slide-02-thumb.png"
                                        ...
                                        <div class="wrapper">
                                            <figure><img src="{{ asset('fe/images/slider/slide-02.jpg') }}"
                                                    alt=""></figure>
                                    ...
                                    <div class="swiper-slide" data-thumb="images/slider/slide-03-thumb.png">
                                        <div class="wrapper">
                                            <figure><img src="{{ asset('fe/images/slider/slide-03.jpg') }}"
                                                    alt=""></figure>
                                    ...
                                    <div class="swiper-slide" data-thumb="images/slider/slide-01-thumb.png">
                                        <div class="wrapper">
                                            <figure><img src="{{ asset('fe/images/slider/slide-01.jpg') }}"
                                                    alt=""></figure>
                                            <div class="caption animate" data-animate="fadeIn">
                                                ...
                                                <div class="text2 animate" data-animate="bounceInLeft"
                                                    data-delay="500"> <strong>New</strong> collection </div>
                                                <div class="text3 animate" data-animate="bounceInLeft"
                                                    data-delay="1500"> WOMEN'S <strong>FASHION</strong> </div>
                ...
                <div class="block">
                    <div class="container">
                        ...
                        <div class="text-center bottom-space">
                            <h1 class="size-lg no-padding">WELCOME TO <span
                                    class="logo-font custom-color">Seikō</span> STORE</h1>
                                        ...
                                        <div class="product-item-info">
                                            ...
                                            <div class="product-item-photo">
                                                ...
                                                <div class="product-item-gallery-main">
                                                    <a href="#"><img class="product-image-photo"
                                                            src="{{ asset('fe/images/products/product-16-c1.jpg') }}"
                                                            alt=""></a>
                                                ...
                                                <div class="product-item-actions">
                                                    <div class="share-button toBottom">
                                                        ...
                                                        <ul class="social-list">
                                                            <li>
                                                                <a href="#"
                                                                    class="icon icon-google google"></a>
                                                            </li>
                                                            <li>
                                                                <a href="#" class="icon icon-fancy fancy"></a>
                                                            </li>
                                            ...
                                            <div class="product-item-details">
                                                <div class="product-item-name"> <a title="Long sleeve overall"
                                                        href="product.html" class="product-item-link">Long sleeve
                                                        overall</a></div>
                                                ...
                                                <div class="price-box"> <span class="price-container"> <span
                                                            class="price-wrapper"> <span
                                                                class="old-price">$190.00</span> <span
                                                                class="special-price">$149.00</span> </span>
                                                    </span>
                                                </div>
                                                <ul class="color-swatch hidden-xs">
                                                    <li class="active">
                                                        <a data-image="images/products/product-16-c1.jpg"
                                                            href="#"><img
                                                                src="{{ asset('fe/images/colorswatch/color-blue.png') }}"
                                                                alt="Blue"></a>
                                                    </li>
                                                    <li>
                                                        <a data-image="images/products/product-16-c2.jpg"
                                                            href="#"><img
                                                                src="images/colorswatch/color-grey.png"
                                                                alt="Gray"></a>
                                                    </li>
                                                    <li>
                                                        <a data-image="images/products/product-16-c3.jpg"
                                                            href="#"><img
                                                                src="images/colorswatch/color-red.png"
                                                                alt="Red"></a>
                                                    </li>
                                                    <li>
                                                        <a data-image="images/products/product-16-c4.jpg"
                                                            href="#"><img
                                                                src="images/colorswatch/color-violet.png"
                                                                alt="Violet"></a>
                                                    </li>
                                                    <li>
                                                        <a data-image="images/products/product-16-c5.jpg"
                                                            href="#"><img
                                                                src="images/colorswatch/color-green.png"
                                                                alt="Green"></a>
                                                    </li>
                                                </ul>
                                                <div class="product-item-rating"> <i
                                        ...
                                        <div class="product-item-info">
                                            ...
                                            <div class="product-item-photo">
                                                ...
                                                <div class="carousel-inside slide" data-ride="carousel">
                                                    <div class="carousel-inner" role="listbox">
                                                        ...
                                                        <div class="item">
                                                            <a href="#"><img class="product-image-photo"
                                                                    src="images/products/product-20-1.jpg"
                                                                    alt=""></a>
                                                        </div>
                                                        <div class="item">
                                                            <a href="#"><img class="product-image-photo"
                                                                    src="images/products/product-20-2.jpg"
                                                                    alt=""></a>
                                                        </div>
                                                    </div>
                                            ...
                                            <div class="product-item-details">
                                                <div class="product-item-name"> <a title="Lace back mini dress"
                                                        href="product.html" class="product-item-link">Lace back mini
                                                        dress</a> </div>
                                                <div class="product-item-description">Neque porro quisquam est, qui
                                                    dolorem ipsum quia dolor sit amet, consectetur, adipisci velit, sed
                                                    quia nonkdni numquam eius modi tempora incidunt ut labore</div>
                                        ...
                                        <div class="product-item-info">
                                            ...
                                            <div class="product-item-photo">
                                                ...
                                                <div class="product-item-gallery">
                                                    ...
                                                    <div class="product-item-gallery-main">
                                                        <a href="#"><img class="product-image-photo"
                                                                src="images/products/product-26.jpg"
                                                                alt=""></a>
                                                        <a href="quick-view.html" title="Quick View"
                                                            class="quick-view-link quick-view-btn"> <i
                                                                class="icon icon-eye"></i><span>Quick View</span></a>
                                            ...
                                            <div class="product-item-details">
                                                <div class="product-item-name"> <a
                                                        title="Grey T-shirt fashion Sportex" href="product.html"
                                                ...
                                                <div class="price-box"> <span class="price-container"> <span
                                                            class="price-wrapper"> <span
                                                                class="old-price">$300.00</span> <span
                                        ...
                                        <div class="product-item-info">
                                            ...
                                            <div class="product-item-details">
                                                <div class="product-item-name"> <a title="Mesh bodycon dress"
                                                        href="product.html" class="product-item-link">Mesh bodycon
                                                        dress</a> </div>
                                                <div class="product-item-description">Neque porro quisquam est, qui
                                                    dolorem ipsum quia dolor sit amet, consectetur, adipisci velit, sed
                                                    quia nonkdni numquam eius modi tempora incidunt ut labore</div>
                                                <div class="price-box"> <span class="price-container"> <span
                                                            class="price-wrapper"> <span
                                                                class="old-price">$290.00</span> <span
                                        ...
                                        <div class="product-item-info">
                                            ...
                                            <div class="product-item-details">
                                                <div class="product-item-name"> <a title="Backless mini dress"
                                                        href="product.html" class="product-item-link">Backless mini
                                                        dress</a> </div>
                                                <div class="product-item-description">Neque porro quisquam est, qui
                                                    dolorem ipsum quia dolor sit amet, consectetur, adipisci velit, sed
                                                    quia nonkdni numquam eius modi tempora incidunt ut labore</div>
                                        ...
                                        <div class="product-item-info">
                                            ...
                                            <div class="product-item-details">
                                                <div class="product-item-name"> <a
                                                        ...
                                                        class="product-item-link">Longline asymmetric midi skirt</a>
                                                </div>
                                                <div class="product-item-description">Neque porro quisquam est, qui
                                                    dolorem ipsum quia dolor sit amet, consectetur, adipisci velit, sed
                                                    quia nonkdni numquam eius modi tempora incidunt ut labore</div>
                                                ...
                                                <div class="product-item-gallery-main">
                                                    ...
                                                    <a href="product.html" class="product-item-not-available">
                                                        <span class="vert-wrapper"><span class="vert"><span
                                                                    class="text">Not Available</span></span>
                                                        </span>
                                                    </a>
                                                </div>
                                                <!-- /product main photo  -->
                                        ...
                                        <div class="product-item-info">
                                            ...
                                            <div class="product-item-details">
                                                <div class="product-item-name"> <a title="Athletic T-Shirt"
                                                        href="product.html" class="product-item-link">Athletic
                                                        T-Shirt</a> </div>
                                                <div class="product-item-description">Neque porro quisquam est, qui
                                                    dolorem ipsum quia dolor sit amet, consectetur, adipisci velit, sed
                                                    quia nonkdni numquam eius modi tempora incidunt ut labore</div>
                                                <div class="price-box"> <span class="price-container"> <span
                                                            class="price-wrapper"> <span
                                                                class="old-price">$420.00</span> <span
                        ...
                        <div class="row">
                            <div class="col-sm-6">
                                <div class="banner style-7 autosize-text image-hover-scale" data-fontratio="9.6">
                                    <img src="images/banners/banner-layout-5.jpg" alt="Banner">
                            ...
                            <div class="col-sm-6">
                                <div class="banner style-8 autosize-text image-hover-scale" data-fontratio="10"><img
                                        src="images/banners/banner-layout-6.jpg" alt="Banner">
                                    <div class="banner-caption horr vertc">
                                        <div class="vert-wrapper">
                                            <div class="vert">
                                                <div class="text-1">Even the<span>hottest</span> day wont’t slow you
                                                    down</div>
                                                <a href="#buttonlink" class="banner-btn-wrap">
                                    ...
                                    <div class="blog-item">
                                        ...
                                        <div class="blog-item-info">
                                            ...
                                            <div class="blog-item-teaser">Repellat aspernatur esse minus. Molestiae
                                                ...
                                                suscipit. Cumque!</div>
                                            <div class="blog-item-links"> <span class="pull-left"> <span><a
                                                            href="#" class="readmore">Read more</a></span>
                                                ...
                                                <div class="product-item-info">
                                                    ...
                                                    <div class="product-item-details">
                                                        <div class="product-item-name"> <a title="Cover up tunic"
                                                                href="product.html" class="product-item-link">Cover
                                                                up tunic</a></div>
                                                        <div class="product-item-description">Neque porro quisquam
                                                            est, qui dolorem ipsum quia dolor sit amet, consectetur,
                                                            adipisci velit, sed quia nonkdni numquam eius modi tempora
                                                        ...
                                                        <ul class="color-swatch hidden-xs">
                                                            <li class="active">
                                                                <a data-image="images/products/product-19.jpg"
                                                                    href="#"><img
                                        ...
                                        <div class="product-item large">
                                            <div class="product-item-inside">
                                                <div class="product-item-info">
                                                    ...
                                                    <div class="product-item-details">
                                                        <div class="product-item-name"> <a
                                                                title="Style Dome Men's Solid Red Color"
                                                                href="product.html" class="product-item-link">Style
                                                                Dome Men's Solid Red Color</a> </div>
                                                        <div class="product-item-description">Neque porro quisquam
                                                            est, qui dolorem ipsum quia dolor sit amet, consectetur,
                                                            adipisci velit, sed quia nonkdni numquam eius modi tempora
                                                            incidunt ut labore</div>
                                        ...
                                        <div class="product-item previews-3 large">
                                            <div class="product-item-inside">
                                                <div class="product-item-info">
                                                    ...
                                                    <div class="product-item-details">
                                                        <div class="product-item-name"> <a
                                                                title="Boyfriend Shorts Denim" href="product.html"
                        ...
                        <div class="row">
                                    ...
                                    <div class="footer-logo">
                                        <a href="#">
                                            <svg version="1.1" id="Layer_2" xmlns="http://www.w3.org/2000/svg"
                                                ...
                                                y="0px" width="175px" height="72px"
                                                viewBox="0 0 175 72" enable-background="new 0 0 175 72"
                                                xml:space="preserve">
                                                <path
                                                    d="M42.913,25.454c-0.159-0.681-0.663-1.109-1.117-1.453c-3.122-2.375-6.649-4.239-10.468-5.54
														c-0.034-0.019-0.067-0.026-0.109-0.043c-0.009,0-0.286-0.092-0.673-0.218c-0.284-0.084-0.419-0.126-0.419-0.126
														...
														c0.035,0.017,0.068,0.025,0.101,0.042c3.609,1.225,6.935,2.98,9.881,5.213c0.11,0.084,0.177,0.143,0.227,0.183
														C40.629,26.058,40.587,26.15,40.53,26.285" />
                                                <rect x="2" y="17.99" fill="none"
                                                    width="41.027" height="35.46" />
                                                <g>
                                                    <path
                                                        d="M69.91,30.947c-0.941-0.564-1.915-1.066-2.919-1.506c-0.848-0.376-1.798-0.729-2.848-1.059
															c-1.053-0.33-2.081-0.495-3.084-0.495c-0.816,0-1.468,0.126-1.955,0.377c-0.486,0.252-0.729,0.675-0.729,1.271
                            ...
                            <div class="col-md-3">
                                ...
                                <a class="twitter-timeline" href="https://twitter.com/ThemeForest"
                                    ...
                                    data-tweet-limit="1" data-widget-id="677235277925113856">Tweets by
                                    @ThemeForest</a>
                                <script>
                                    ! function(d, s, id) {
                                    ...
                                    <div class="collapsed-content">
                                        ...
                                        <div class="footer-social">
                                            <a href="#"><i
                                                ...
                                                href="#"><i
                                                    class="icon icon-twitter-logo icon-circled"></i></a> <a
                                                href="#"><i class="icon icon-skype-logo icon-circled"></i></a>
                            ...
                            <div class=" col-md-6 col-lg-4">
                                ...
                                <div class="footer-payment-link text-center">
                                    <a href="#"><img src="images/payment-logo/icon-pay-1.png"
                                            alt=""></a>
                                    <a href="#"><img src="images/payment-logo/icon-pay-2.png"
                                            alt=""></a>
                                    <a href="#"><img src="images/payment-logo/icon-pay-3.png"
                                            alt=""></a>
                                    <a href="#"><img src="images/payment-logo/icon-pay-4.png"
                                            alt=""></a>
                                </div>
                            </div>
                        </div>
                ...
                <ul class="products-list">
                    <li>
                        ...
                        <div class="actions">
                            ...
                            <a class="action delete" href="#" title="Delete item"><i
                    ...
                    <li>
                        <a href="product.html" title="Product Name Long Name"><img class="product-image-photo"
                                src="images/products/product-11.jpg" alt=""></a>
                        <span class="item-qty">3</span>
                        <div class="actions">
                    ...
                    <li>
                        <a href="product.html" title="Product Name Long Name"><img class="product-image-photo"
                                src="images/products/product-12.jpg" alt=""></a>
                        <span class="item-qty">3</span>
                        <div class="actions">
                            <a class="action edit" href="#" title="Edit item"><i
                                    class="icon icon-pencil"></i></a>
                    ...
                    <li>
                        <a href="product.html" title="Product Name Long Name"><img class="product-image-photo"
                                src="images/products/product-14.jpg" alt=""></a>
                        <span class="item-qty">3</span>
                        <div class="actions">
                            <a class="action edit" href="#" title="Edit item"><i
                                    class="icon icon-pencil"></i></a>
                    ...
                    <li>
                        <a href="product.html" title="Product Name Long Name"><img class="product-image-photo"
                                src="images/products/product-15.jpg" alt=""></a>
                        <span class="item-qty">3</span>
                        <div class="actions">
                            <a class="action edit" href="#" title="Edit item"><i
                                    class="icon icon-pencil"></i></a>
    ...
    <!-- jQuery Scripts  -->
    <script src="{{ asset('fe/js/vendor/jquery/jquery.js') }}"></script>
    <script src="{{ asset('fe/js/vendor/bootstrap/bootstrap.min.js') }}"></script>
    <script src="{{ asset('fe/js/vendor/swiper/swiper.min.js') }}"></script>
    <script src="{{ asset('fe/js/vendor/slick/slick.min.js') }}"></script>
    <script src="{{ asset('fe/js/vendor/parallax/parallax.js') }}"></script>
    <script src="{{ asset('fe/js/vendor/isotope/isotope.pkgd.min.js') }}"></script>
    <script src="{{ asset('fe/js/vendor/magnificpopup/dist/jquery.magnific-popup.js') }}"></script>
    <script src="{{ asset('fe/js/vendor/countdown/jquery.countdown.min.js') }}"></script>
    <script src="{{ asset('fe/js/vendor/nouislider/nouislider.min.js') }}"></script>
    <script src="{{ asset('fe/js/vendor/ez-plus/jquery.ez-plus.js') }}"></script>
    <script src="{{ asset('fe/js/vendor/tocca/tocca.min.js') }}"></script>
    <script src="{{ asset('fe/js/vendor/bootstrap-tabcollapse/bootstrap-tabcollapse.js') }}"></script>
    <script src="{{ asset('fe/js/vendor/scrollLock/jquery-scrollLock.min.js') }}"></script>
    <script src="{{ asset('fe/js/vendor/darktooltip/dist/jquery.darktooltip.js') }}"></script>
    <script src="{{ asset('fe/js/vendor/imagesloaded/imagesloaded.pkgd.min.js') }}"></script>
    <script src="{{ asset('fe/js/vendor/instafeed/instafeed.min.js') }}"></script>
    <script src="{{ asset('fe/js/megamenu.min.js') }}"></script>
    <script src="{{ asset('fe/js/tools.min.js') }}"></script>
