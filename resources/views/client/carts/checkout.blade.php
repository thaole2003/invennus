                ...
                <div class="col-lg-6 col-md-12">
                    <div class="billing-details">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-12 col-md-12">
                                <div class="form-group">
                                    <textarea name="note" name="notes" id="notes" cols="30" rows="6" placeholder="Ghi chú" lass="form-control"></textarea>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-lg-6 col-md-12">
                    <div class="order-details">
                                ...
                                {{  $totalAmount=0 }}
                                    ...
                                    @foreach ($carts as $value)
                                        <tr>
                                            <td class="product-name">
                                                <a href="#">{{ $value->ProductVariant->product->title }}</a> <span> x {{ $value->quantity }}</span>
                                            </td>

                                            <td class="product-total">
                                                <span class="subtotal-amount">{{number_format($subtotal= $value->quantity* $value->ProductVariant->price) }}</span>
                                            </td>
                                        </tr>
                                    ...
                                    <tr>
                                        ...
                                        <td class="product-subtotal">
                                            <span class="subtotal-amount">{{ number_format($totalAmount + $ship) }}</span>
                                            <input type="text" name="total_price" value="{{ $totalAmount + $ship }}" hidden>
                                        </td>
                                    </tr>
                                </tbody>
                            </table>
                        ...
                        <div class="payment-method">
                            ...
                            <p>
                                <input type="radio" id="paypal" name="pay_method" value="paypal" name="radio-group">
